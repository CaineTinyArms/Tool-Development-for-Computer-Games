...
//	ground.Init();
	...
	cout << "Camera Selected: Front View"<< endl; // Outputs the starting camera view.
	cout << "Camera Move View Selected" << endl; // Outputs the starting move mode.
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Clear the screen
		glClearColor(0.141f, 0.227f, 0.522f, 1.0f); // Sets the background to a dark blue.
		...
		GUI.scene.NavSet.draw(viewProjectionMatrix); // Calls the draw function of every NavPoint in the NavSet.
