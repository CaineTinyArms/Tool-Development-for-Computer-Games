...
__published:	// IDE-managed Components
	...
	void __fastcall N2x21Click(TObject *Sender);
	void __fastcall SpeedButton1Click(TObject *Sender);
	void __fastcall FormResize(TObject *Sender);
	void __fastcall TimerResizeTimer(TObject *Sender);
	void __fastcall TimerResize2Timer(TObject *Sender);
...
public:		// User declarations
	...
	void __fastcall MirrorHorizontal(bool);
	void __fastcall MirrorVertical(bool);
	void __fastcall Fill(TShiftState Shift,int,int,int,int,int,int,bool);
