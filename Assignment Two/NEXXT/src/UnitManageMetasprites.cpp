	...
	void __fastcall TFormManageMetasprites::Update(void)
{
	...
	if (ListBoxSprites->Items->Count == 0){
		for(i=0;i<256;++i) ListBoxSprites->Items->Add("");
	}
...
void __fastcall TFormManageMetasprites::UpdateActive(bool doBitmap)
{
  ...
  if (ListBoxSprites->Items->Count > 0) ListBoxSprites->Items->Strings[metaSpriteActive]=str;
...
void __fastcall TFormManageMetasprites::FormCreate(TObject *Sender)
{
	...
	Update();
	UpdateActive(true);
	if(prefStartShowMM) FormManageMetasprites->Visible=true;
	if(prefStartPinMM)  {
		FormManageMetasprites->PopupMode=pmExplicit;
		FormMain->PinMetaspriteManagerDirectAnimator1->Checked=true;
	} else{
		FormManageMetasprites->PopupMode=pmNone;
    	FormMain->PinMetaspriteManagerDirectAnimator1->Checked=false;
	}
}
//---------------------------------------------------------------------------
