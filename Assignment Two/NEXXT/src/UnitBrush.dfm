object FormBrush: TFormBrush
  ...
  object PopupMenu1: TPopupMenu
    ...
    object N3stepsateensrecommendedforNES1: TMenuItem
      Caption = '3-step sateen dithers (NES recommended)'
      object oyoradither0degreesrecommended1: TMenuItem
        Tag = 8
        Caption = '3-step sateen, 0 degrees (shimmer free)'
        OnClick = oyoradither0degreesrecommended1Click
      end
      object N3stepsateen90degrees1: TMenuItem
        Tag = 8
        Caption = '3-step sateen, 90 degrees'
        OnClick = N3stepsateen90degrees1Click
      end
      object N3stepsateen180degrees1: TMenuItem
        Tag = 8
        Caption = '3-step sateen, 180 degrees'
        OnClick = N3stepsateen180degrees1Click
      end
      object N3stepsateeb270degrees1: TMenuItem
        Tag = 8
        Caption = '3-step sateen, 270 degrees'
        OnClick = N3stepsateeb270degrees1Click
      end
      object N14: TMenuItem
        Caption = '-'
      end
      object N3stepsateen0degreesrighttoleftgrowshimmerfree1: TMenuItem
        Tag = 8
        Caption = 'ToffiRola'#39's '#39'Zebra1'#39' (left-growth sateen; shimmer free)'
        OnClick = N3stepsateen0degreesrighttoleftgrowshimmerfree1Click
      end
      object N3stepsateenrightgrowthshimmerfree1: TMenuItem
        Tag = 8
        Caption = 'Right-growth 3-step sateen (shimmer free)'
        OnClick = N3stepsateenrightgrowthshimmerfree1Click
      end
      object Zigzagleftthenright3stepsateenshimmerfree1: TMenuItem
        Caption = #39'Zigzag'#39' (left, then right) 3-step sateen (shimmer free)'
        OnClick = Zigzagleftthenright3stepsateenshimmerfree1Click
      end
      object Zigzagleftthenright3stepsateenshimmerfree2: TMenuItem
        Caption = #39'Zigzag'#39' (right, then left) 3-step sateen (shimmer free)'
        OnClick = Zigzagleftthenright3stepsateenshimmerfree2Click
      end
    end
    object Dithers1: TMenuItem
      Caption = 'Bayer dithers'
      object Ordered4x4Bayermatrix1: TMenuItem
        Tag = 4
        Caption = 'Ordered 4x4 Bayer matrix, low'
        OnClick = Ordered4x4Bayermatrix1Click
      end
      object Ordered4x4Bayermatrixmid1: TMenuItem
        Tag = 4
        Caption = 'Ordered 4x4 Bayer matrix, mid'
        OnClick = Ordered4x4Bayermatrixmid1Click
      end
      object Ordered4x4Bayermatrixhighhalf1: TMenuItem
        Tag = 4
        Caption = 'Ordered 4x4 Bayer matrix, high'
        OnClick = Ordered4x4Bayermatrixhighhalf1Click
      end
      object N15: TMenuItem
        Caption = '-'
      end
      object Ordered4x4Bayermatrixevens1: TMenuItem
        Tag = 4
        Caption = 'Ordered 4x4 Bayer matrix, even'
        OnClick = Ordered4x4Bayermatrixevens1Click
      end
      object Ordered4x4Bayermatrixodd1: TMenuItem
        Tag = 4
        Caption = 'Ordered 4x4 Bayer matrix, odd'
        OnClick = Ordered4x4Bayermatrixodd1Click
      end
    end
  end
