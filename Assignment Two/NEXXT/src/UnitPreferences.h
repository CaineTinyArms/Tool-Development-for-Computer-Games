...
__published:
	...
	TRadioButton *RadioFilename;
	TRadioButton *RadioFilenameFolder;
	TRadioButton *RadioFullPath;
	TGroupBox *GroupBox13;
	TRadioButton *RadioImportCHRWrap;
	TRadioButton *RadioImportCHRCarry;
	TRadioButton *RadioImportCHRSkip;
	TGroupBox *GroupBox14;
	TRadioButton *RadioAsmCaSign;
	TRadioButton *RadioAsmOtherSign;
	TCheckBox *CheckMsprCyan;
	TCheckBox *CheckGridTilesCHR;
	TCheckBox *CheckGridMidpointsCHR;
	TCheckBox *CheckShowBrushes;
	TCheckBox *CheckShowBucket;
	TCheckBox *CheckShowLines;
	TGroupBox *GroupBox15;
	TCheckBox *CheckShowMsprListID;
	TCheckBox *CheckShowMsprListLabel;
	TCheckBox *CheckShowMsprListNTSC;
	TCheckBox *CheckShowMsprListPAL;
	TCheckBox *CheckShowMsprListCount;
	TCheckBox *CheckShowMsprListTag;
	TCheckBox *CheckIncludeNTSC;
	TCheckBox *CheckIncludePAL;
	TGroupBox *GroupBox16;
	TRadioButton *RadioAnimAsTable;
	TRadioButton *RadioAnimAsFooter;
	TGroupBox *GroupBox17;
	TRadioButton *Radio6bit;
	TRadioButton *Radio8bit;
	TRadioButton *Radio14bit;
	TGroupBox *GroupBox18;
	TCheckBox *CheckAntiJagEnabled;
	TGroupBox *GroupBox19;
	TRadioButton *RadioExportDefaultPNG;
	TRadioButton *RadioExportDefaultBMP;
	TGroupBox *GroupBox20;
	TCheckBox *CheckExportIncludeNonactiveSupbals;
	TCheckBox *CheckExportIncludeSystemLUT;
	TGroupBox *GroupBox21;
	TRadioButton *RadioExportVerticalSystemLUT;
	TRadioButton *RadioExportHorizontalSystemLUT;
	TGroupBox *GroupBox22;
	TCheckBox *CheckPinCHREditor;
	TCheckBox *CheckPinMetaspriteManager;
	TCheckBox *CheckPinBrushes;
	TCheckBox *CheckPinBucket;
	TCheckBox *CheckPinLines;
	TCheckBox *CheckShowPaste;
	TCheckBox *CheckPinPaste;
	TCheckBox *CheckShowBankSelector;
	TCheckBox *CheckShowNavigator;
	TCheckBox *CheckShowMetatileEditor;
	TCheckBox *CheckShowColourRose;
	TCheckBox *CheckShowBankSwapper;
	TCheckBox *CheckPinNavigator;
	TCheckBox *CheckPinBankSelector;
	TCheckBox *CheckPinBankSwapper;
	TCheckBox *CheckPinMetatileEditor;
	TCheckBox *CheckPinColourRose;
	TCheckBox *CheckGrid8;
