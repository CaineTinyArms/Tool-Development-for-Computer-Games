...
void __fastcall TAboutBox::FormShow(TObject *Sender)
{
	...
	+"\n\nBarry White, Colin Reed, Cornel, Howie Day, Jone, Margaret McNulty-Beldyk, "
	+"Matt Roszak, Paul Preuss, Raftronaut, Rusty Gerard, an insignifant speck of dust, "
	+"Ben Smith, Dan Fries, Deadeye, Infinite NES Lives LLC, Jacob Speicher, Jo, Joe's Computer Museum, "
	+"Joe Pail, Justin Orenich, Kacper Woźniak, Kalle Siukola, Matthew Klundt, Max Meiners, "
	+"Michael Thompson, michael_emh, Ninja Dynamics, Pete Spicer, Pez Pengelly, "
	+"Ratttz, ReJ aka Renaldas Zioma, RT, Scott Walters, Sean Robinson, W-, Amina, "
	+"André Luís Baptista da Silva, BIG EVIL CORPORATION, Colin Kingfisher, "
	+"Eric DeSantis, Frank Provo, Marc Moore, Maxim Sergeevich, Nicholas Berthiaume, "
	+"NovaSquirrel, RetroNES Software, Yonghai Yu, zeta0134, zzox."
	;
