...
USEFORM("UnitWelcome.cpp", FormWelcome);
USEFORM("UnitPatternPaintToolbox.cpp", FormPatternPaint);
//---------------------------------------------------------------------------
#include "FreeImage.h"
WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
	try
	{
		...
		Application->Title = "NEXXT studio 3.3.2";
		...
		Application->CreateForm(__classid(TFormWelcome), &FormWelcome);
		Application->CreateForm(__classid(TFormPatternPaint), &FormPatternPaint);
		Application->Run();
	}
