...
__published:	// IDE-managed Components
	...
	TMenuItem *N2;
	TMenuItem *Dithers1;
	TMenuItem *oyoradither0degreesrecommended1;
	TMenuItem *N3stepsateen90degrees1;
	TMenuItem *N3stepsateen180degrees1;
	TMenuItem *N3stepsateeb270degrees1;
	TMenuItem *Ordered4x4Bayermatrix1;
	TMenuItem *Ordered4x4Bayermatrixhighhalf1;
	TMenuItem *Ordered4x4Bayermatrixmid1;
	TMenuItem *Ordered4x4Bayermatrixevens1;
	TMenuItem *Ordered4x4Bayermatrixodd1;
	TMenuItem *N3stepsateen0degreesrighttoleftgrowshimmerfree1;
	TMenuItem *N3stepsateenrightgrowthshimmerfree1;
	TMenuItem *N3stepsateensrecommendedforNES1;
	TMenuItem *N14;
	TMenuItem *N15;
	TMenuItem *Zigzagleftthenright3stepsateenshimmerfree1;
	TMenuItem *Zigzagleftthenright3stepsateenshimmerfree2;
	...
	void __fastcall oyoradither0degreesrecommended1Click(TObject *Sender);
	void __fastcall N3stepsateen90degrees1Click(TObject *Sender);
	void __fastcall N3stepsateen180degrees1Click(TObject *Sender);
	void __fastcall N3stepsateeb270degrees1Click(TObject *Sender);
	void __fastcall Ordered4x4Bayermatrix1Click(TObject *Sender);
	void __fastcall Ordered4x4Bayermatrixmid1Click(TObject *Sender);
	void __fastcall Ordered4x4Bayermatrixhighhalf1Click(TObject *Sender);
	void __fastcall Ordered4x4Bayermatrixevens1Click(TObject *Sender);
	void __fastcall Ordered4x4Bayermatrixodd1Click(TObject *Sender);
	void __fastcall N3stepsateen0degreesrighttoleftgrowshimmerfree1Click(
          TObject *Sender);
	void __fastcall N3stepsateenrightgrowthshimmerfree1Click(TObject *Sender);
	void __fastcall Zigzagleftthenright3stepsateenshimmerfree1Click(
          TObject *Sender);
	void __fastcall Zigzagleftthenright3stepsateenshimmerfree2Click(
          TObject *Sender);
