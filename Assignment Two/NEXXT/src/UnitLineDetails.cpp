...
void __fastcall TFormLineDetails::FormCreate(TObject *Sender)
{
	...
	if(prefStartPinLines)  {
		FormLineDetails->PopupMode=pmExplicit;
		FormMain->PinLinetoolbox1->Checked=true;
	} else{
		FormLineDetails->PopupMode=pmNone;
		FormMain->PinLinetoolbox1->Checked=false;
	}
}
//---------------------------------------------------------------------------
