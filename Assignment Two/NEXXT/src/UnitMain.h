...
class TFormMain : public TForm
{
	...
	TMenuItem *Reloadsession1;
	TMenuItem *CopycollisionpropertiesasCheader1;
	TMenuItem *Setemptyspacestonulltile1;
	TMenuItem *Pin1;
	TMenuItem *PinCHREditor1;
	TMenuItem *PinMetaspriteManagerDirectAnimator1;
	TMenuItem *PinNavigator1;
	TMenuItem *PinCHRbankselector1;
	TMenuItem *PinCHRbankswapper1;
	TMenuItem *PinMetatiletool1;
	TMenuItem *PinColourrose1;
	TMenuItem *PinBrushtoolbox1;
	TMenuItem *PinLinetoolbox1;
	TMenuItem *PinBuckettoolbox1;
	TMenuItem *PinSpecialpastetoolbox1;
	TMenuItem *N101;
	TSpeedButton *btnStripSet;
	TMenuItem *Displayrepeatingpatternsmode1;
	TMenuItem *PatternPainttoolbox1;
	...
	void __fastcall Protect3MouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y);
	void __fastcall Reloadsession1Click(TObject *Sender);
	void __fastcall CopycollisionpropertiesasCheader1Click(TObject *Sender);
	void __fastcall Setemptyspacestonulltile1Click(TObject *Sender);
	void __fastcall PinCHREditor1Click(TObject *Sender);
	void __fastcall PinSpecialpastetoolbox1Click(TObject *Sender);
	void __fastcall PinBuckettoolbox1Click(TObject *Sender);
	void __fastcall PinLinetoolbox1Click(TObject *Sender);
	void __fastcall PinBrushtoolbox1Click(TObject *Sender);
	void __fastcall PinColourrose1Click(TObject *Sender);
	void __fastcall PinMetatiletool1Click(TObject *Sender);
	void __fastcall PinCHRbankswapper1Click(TObject *Sender);
	void __fastcall PinCHRbankselector1Click(TObject *Sender);
	void __fastcall PinNavigator1Click(TObject *Sender);
	void __fastcall PinMetaspriteManagerDirectAnimator1Click(TObject *Sender);
	void __fastcall btnStripSetClick(TObject *Sender);
	void __fastcall btnStripSetMouseEnter(TObject *Sender);
	void __fastcall Displayrepeatingpatternsmode1Click(TObject *Sender);
	void __fastcall PatternPainttoolbox1Click(TObject *Sender);
...
public:		// User declarations
    ...
    void __fastcall DrawSateenStrip(int x, int y, int pal);
    ...
    void __fastcall CreateWelcomeConfig(void);
    bool __fastcall LoadWelcomeConfig(void);
